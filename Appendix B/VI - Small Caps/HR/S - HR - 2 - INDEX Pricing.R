...
sigma = sd(SnP600small_HR) * sqrt(252)

So_index = as.numeric(tail(closing_prices["2025-08-01"]))

################# EW INDEX HEDGE #################

PortfolioValue_S_HR_EW = sum(Table_SEW_HR$Numb_Stocks * Table_SEW_HR$So)
PORT_VAL = PortfolioValue_S_HR_EW
BETA = Beta_S_HR_EW

Hedge_Info_Small_HR_EW <- rbind(
...
rownames(Hedge_Info_Small_HR_EW) = c("OTM_10", "OTM_5", "ATM_0", "ITM_5")
Hedge_Info_Small_HR_EW
View(Hedge_Info_Small_HR_EW)
...
PortfolioValue_S_HR_VW = sum(Table_SVW_HR$Numb_Stocks * Table_SVW_HR$So)
PORT_VAL = PortfolioValue_S_HR_VW
BETA = Beta_S_HR_VW

Hedge_Info_Small_HR_VW <- rbind(
  Hedge_INDEX(sigma, 0.9,  So_index, r = rate, PortfolioBeta = BETA, PortfolioValue = PORT_VAL, lambda = lambda, muJ = muJ, sigmaJ = sigmaJ),
  Hedge_INDEX(sigma, 0.95, So_index, r = rate, PortfolioBeta = BETA, PortfolioValue = PORT_VAL, lambda = lambda, muJ = muJ, sigmaJ = sigmaJ),
  Hedge_INDEX(sigma, 1.0,  So_index, r = rate, PortfolioBeta = BETA, PortfolioValue = PORT_VAL, lambda = lambda, muJ = muJ, sigmaJ = sigmaJ),
  Hedge_INDEX(sigma, 1.05, So_index, r = rate, PortfolioBeta = BETA, PortfolioValue = PORT_VAL, lambda = lambda, muJ = muJ, sigmaJ = sigmaJ)
...
rownames(Hedge_Info_Small_HR_VW) = c("OTM_10", "OTM_5", "ATM_0", "ITM_5")
Hedge_Info_Small_HR_VW
View(Hedge_Info_Small_HR_VW)

################# IW #################

PortfolioValue_S_HR_IW = sum(Table_SIW_HR$Numb_Stocks * Table_SIW_HR$So)
PORT_VAL = PortfolioValue_S_HR_IW
BETA = Beta_S_HR_IW

Hedge_Info_Small_HR_IW <- rbind(
  Hedge_INDEX(sigma, 0.9,  So_index, r = rate, PortfolioBeta = BETA, PortfolioValue = PORT_VAL, lambda = lambda, muJ = muJ, sigmaJ = sigmaJ),
  Hedge_INDEX(sigma, 0.95, So_index, r = rate, PortfolioBeta = BETA, PortfolioValue = PORT_VAL, lambda = lambda, muJ = muJ, sigmaJ = sigmaJ),
  Hedge_INDEX(sigma, 1.0,  So_index, r = rate, PortfolioBeta = BETA, PortfolioValue = PORT_VAL, lambda = lambda, muJ = muJ, sigmaJ = sigmaJ),
  Hedge_INDEX(sigma, 1.05, So_index, r = rate, PortfolioBeta = BETA, PortfolioValue = PORT_VAL, lambda = lambda, muJ = muJ, sigmaJ = sigmaJ)
...
rownames(Hedge_Info_Small_HR_IW) = c("OTM_10", "OTM_5", "ATM_0", "ITM_5")
Hedge_Info_Small_HR_IW
View(Hedge_Info_Small_HR_IW)
